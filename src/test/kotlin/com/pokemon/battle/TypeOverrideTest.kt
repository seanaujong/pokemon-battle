...
class TypeOverrideTest {
    ...
    fun `Camomons type override changes effectiveness`() {
        ...
        assertEquals(Effectiveness.NOT_VERY_EFFECTIVE, damage.effectiveness,
    ...
    fun `Camomons STAB changes with type override`() {
        ...
        val withOverride = PokemonState(pikachu, currentHp = pikachu.maxHp,
        ...
        assertTrue(damageWithSTAB.damage > damageWithoutSTAB.damage,
