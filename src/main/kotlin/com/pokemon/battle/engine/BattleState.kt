...
data class BattleState(
    ...
    fun benchFor(side: Side): List<PokemonState> =
        bench[side] ?: emptyList()
    ...
    companion object {
        fun singles(
            p1: PokemonState, p2: PokemonState,
        ...
        private fun buildBench(p1Bench: List<PokemonState>, p2Bench: List<PokemonState>): Map<Side, List<PokemonState>> {
